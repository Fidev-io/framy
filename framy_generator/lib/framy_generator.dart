...
import 'package:framy_generator/generator/gallery_app_generator.dart';
import 'package:framy_generator/generator/home_page_generator.dart';
import 'package:framy_generator/generator/imports_generator.dart';
import 'package:framy_generator/generator/layout_builder_generator.dart';
import 'package:framy_generator/generator/main_generator.dart';
import 'package:framy_generator/generator/material_components_generator.dart';
import 'package:framy_generator/generator/page_configs_generator.dart';
...
class FramyGenerator extends GeneratorForAnnotation<FramyApp> {
  final injectableConfigFiles = Glob("**.framy.json");
